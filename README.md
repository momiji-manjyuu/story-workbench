...
Japanese version: [README.ja.md](/Users/user/story-workbench/README.ja.md)
...
6. Update `data/state/` and `data/plot/` to reflect what changed.
7. Run `python3 tools/story.py checkpoint ...` so the next session can resume cleanly.
   `checkpoint` now blocks if validation or semantic errors remain, unless you deliberately use `--allow-findings`.
8. Re-run `python3 tools/story.py validate` and `audit`.
...
- [`docs/architecture.md`](/Users/user/story-workbench/docs/architecture.md)
- [`docs/workflow.md`](/Users/user/story-workbench/docs/workflow.md)
- [`docs/context-contract.md`](/Users/user/story-workbench/docs/context-contract.md)
- [`docs/drafting-and-audit.md`](/Users/user/story-workbench/docs/drafting-and-audit.md)
- [`docs/write-through.md`](/Users/user/story-workbench/docs/write-through.md)
